...
ckp_config = dict(
    dirpath='06-01-24/11:00:08-[backbone-exp]-[conv-bs-256-lr-3e-4]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/11:00:08-[backbone-exp]-[conv-bs-256-lr-3e-4]'
device = 'cuda'
enable_wandb = True
