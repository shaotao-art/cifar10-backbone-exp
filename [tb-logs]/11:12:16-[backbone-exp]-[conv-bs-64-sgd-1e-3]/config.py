...
ckp_config = dict(
    dirpath='06-01-24/11:12:16-[backbone-exp]-[conv-bs-64-sgd-1e-3]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/11:12:16-[backbone-exp]-[conv-bs-64-sgd-1e-3]'
device = 'cuda'
enable_wandb = True
...
norm_type = 'bn'
num_ep = 100
optimizer_config = dict(config=dict(lr=0.001, momentum=0.9), type='sgd')
resume_ckpt_path = None
run_name = 'conv-bs-64-sgd-1e-3'
