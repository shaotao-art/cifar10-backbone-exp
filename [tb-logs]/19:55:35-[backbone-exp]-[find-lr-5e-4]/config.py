...
ckp_config = dict(
    dirpath='06-11-24/19:55:35-[backbone-exp]-[find-lr-5e-4]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-11-24/19:55:35-[backbone-exp]-[find-lr-5e-4]'
device = 'cuda'
enable_wandb = True
...
norm_type = 'none'
num_ep = 100
optimizer_config = dict(config=dict(lr=0.0005), type='adamw')
resume_ckpt_path = None
run_name = 'find-lr-5e-4'
