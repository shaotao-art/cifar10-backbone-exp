...
ckp_config = dict(
    dirpath='06-01-24/20:57:31-[backbone-exp]-[scale-model-num-conv-2-no-bn]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/20:57:31-[backbone-exp]-[scale-model-num-conv-2-no-bn]'
device = 'cuda'
enable_wandb = True
...
run_name = 'scale-model-num-conv-2-no-bn'
