...
ckp_config = dict(
    dirpath='06-01-24/20:35:09-[backbone-exp]-[scale-model-num-conv-6-res]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/20:35:09-[backbone-exp]-[scale-model-num-conv-6-res]'
device = 'cuda'
enable_wandb = True
...
run_name = 'scale-model-num-conv-6-res'
