...
ckp_config = dict(
    dirpath='06-01-24/12:58:44-[backbone-exp]-[torch-instance-norm]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/12:58:44-[backbone-exp]-[torch-instance-norm]'
device = 'cuda'
enable_wandb = True
...
model_config = dict(
    ...
    base_block_config=dict(
        act='relu',
        in_channels=256,
        norm_config=dict(config=dict(num_features=256), type='in'),
        out_channels=256),
