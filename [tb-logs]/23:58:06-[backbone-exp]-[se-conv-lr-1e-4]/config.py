...
ckp_config = dict(
    dirpath='05-31-24/23:58:06-[backbone-exp]-[se-conv-lr-1e-4]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '05-31-24/23:58:06-[backbone-exp]-[se-conv-lr-1e-4]'
device = 'cuda'
enable_wandb = True
...
norm_type = 'bn'
num_ep = 10
optimizer_config = dict(config=dict(lr=0.0001), type='adamw')
resume_ckpt_path = None
run_name = 'se-conv-lr-1e-4'
