...
ckp_config = dict(
    dirpath='06-01-24/20:36:51-[backbone-exp]-[scale-model-num-conv-6-no-bn]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/20:36:51-[backbone-exp]-[scale-model-num-conv-6-no-bn]'
device = 'cuda'
enable_wandb = True
...
model_config = dict(
    ...
    norm_type='none',
    num_block_per_stage=6)
norm_type = 'none'
num_ep = 100
optimizer_config = dict(config=dict(lr=0.0003), type='adamw')
resume_ckpt_path = None
run_name = 'scale-model-num-conv-6-no-bn'
