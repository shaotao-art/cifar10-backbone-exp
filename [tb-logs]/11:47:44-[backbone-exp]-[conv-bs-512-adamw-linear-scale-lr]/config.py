...
ckp_config = dict(
    dirpath=
    '06-01-24/11:47:44-[backbone-exp]-[conv-bs-512-adamw-linear-scale-lr]',
    every_n_epochs=None,
    save_last=None)
ckp_root = '06-01-24/11:47:44-[backbone-exp]-[conv-bs-512-adamw-linear-scale-lr]'
device = 'cuda'
enable_wandb = True
...
norm_type = 'bn'
num_ep = 100
optimizer_config = dict(config=dict(lr=0.0024), type='adamw')
resume_ckpt_path = None
run_name = 'conv-bs-512-adamw-linear-scale-lr'
